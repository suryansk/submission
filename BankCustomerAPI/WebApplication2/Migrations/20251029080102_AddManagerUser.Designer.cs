...
namespace WebApplication2.Migrations
{
    ...
    [Migration("20251029080102_AddManagerUser")]
    partial class AddManagerUser
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Users", "training", t =>
                        {
                            t.Property("Department")
                                .HasColumnName("BankUser_Department");

                            t.Property("EmployeeId")
                                .HasColumnName("BankUser_EmployeeId");

                            t.Property("PrimaryBankId")
                                .HasColumnName("BankUser_PrimaryBankId");
                        });

                    b.HasDiscriminator().HasValue("BankUser");
                });

            modelBuilder.Entity("WebApplication2.Models.Entities.ManagerUser", b =>
                {
                    b.HasBaseType("WebApplication2.Models.Entities.User");
